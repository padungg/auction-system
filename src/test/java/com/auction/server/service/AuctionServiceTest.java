...
class AuctionServiceTest {
    ...
    static class AutoBidDAOStub implements com.auction.server.dao.AutoBidDAO {
        @Override public List<com.auction.model.entity.AutoBidEntry> findAll() { return new ArrayList<>(); }
        @Override public boolean save(com.auction.model.entity.AutoBidEntry entry) { return true; }
